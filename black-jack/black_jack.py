...
def value_of_ace(card_one, card_two):
    ...
    A = 11 if card_one == 'A' else value_of_card(card_one)
    B = 11 if card_two == 'A' else value_of_card(card_two)b
...
def is_blackjack(card_one, card_two):
    ...
    """
    A = 11 if card_one == 'A' else value_of_card(card_one)
    B = 11 if card_two == 'A' else value_of_card(card_two)
...
def can_split_pairs(card_one, card_two):
    ...
    """
    A = "10" if card_one in ["J", "Q", "K"] else card_one
    B = "10" if card_two in ["J", "Q", "K"] else card_two
